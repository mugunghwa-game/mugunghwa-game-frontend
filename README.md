...
tensorflow가 제공하는 17개의 신체좌표를 활용하여 왼쪽과 오른쪽의 눈의 각도, 어깨와 팔꿈치 사이의 각도, 양쪽 어깨의 각도, 골반과 무릎의 각도를 구할 수 있었습니다.

게임을 하려면 컴퓨터와 어느정도의 거리가 있어야 했는데 3번의 기회로 어느정도 컴퓨터에 가까이 다가와야 하고 아이들도 함께 할 수 있는 게임으로 기획했기 때문에 너무 가깝지도 멀지도 않은 3m정도로 설정했습니다.

**2) 하지만 사용자들이 컴퓨터로부터 3m 이상 떨어져 있다는 것을 어떻게 알 수 있을까?**
